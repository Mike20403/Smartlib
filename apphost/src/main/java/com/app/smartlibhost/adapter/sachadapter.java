...
public  class sachadapter extends RecyclerView.Adapter<sachadapter.item_holder> {
    Context context;

    public sachadapter(Context context, ArrayList<SachFB> arraysach) {
    ...
    public item_holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dongsach,null);
    ...
    public void onBindViewHolder(@NonNull item_holder item_holder, int i) {
        ...
        Picasso.with(context).load(sach.getImg_sach())
                .placeholder(R.drawable.no_img)
                .error(R.drawable.no_img)
                .into(item_holder.img_sach);
        item_holder.tacgia.setText(sach.getTentacgia());
            ...
            super(itemView);
             itemView.setOnClickListener(new View.OnClickListener() {
                 ...
                 public void onClick(View v) {
                    ...
                    // Toast.makeText(context,""+arraysach.get(getPosition()).getId_sach(),Toast.LENGTH_SHORT).show();
