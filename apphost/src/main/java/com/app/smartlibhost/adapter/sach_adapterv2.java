...
public  class sach_adapterv2 extends RecyclerView.Adapter<sach_adapterv2.item_holder> {
    Context context;

    public sach_adapterv2(Context context, ArrayList<SachFB> arraysach) {
    ...
    public item_holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.dong_recycle2,null);
